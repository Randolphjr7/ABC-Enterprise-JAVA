    ...
    public static void main(String[] args) {
        ...
        while (!done) {
            ...
            int menu = GetData.getInt("\tABC ENTERPRISE\n"
                    ...
                    + "\n3. Make a Sale or Place an Order" 
                    + "\n4. Delete a Product"
            ...
            switch (menu) {
                ...
                case 1: // Creating Product and storing it in the database
                    ...
                    String street = GetData.getWord("Enter Company Street "
                            + "Address");
                ...
                case 2: // Update Product
                    ...
                    name = GetData.getWord("Enter name of product you want to "
                            + "update");

                    db.search(name);
                    if (!db.inList()) {
                        JOptionPane.showMessageDialog(null, "Product Name not "
                                + "found");
                    } else {
                        JOptionPane.showMessageDialog(null, "Product Name "
                                + "found!"
                                + "");
                        int option = GetData.getInt("Would you like to (1) "
                                + "change Price, (2) Change "
                                + "Quantity");
                        switch (option) {
                            case 1:
                                double newPrice = GetData.getDouble("Enter new "
                                        + "Price");
                               ...
                               JOptionPane.showMessageDialog(null, "New "
                                ...
                                break;
                            case 2:
                                int newQuantity = GetData.getInt("Enter new "
                                        + "Quantity");
                    ...
                    break;
                case 3: // Make A Sale or Place a new Order
                    name = GetData.getWord("Enter name of product");
                    ...
                    if (!db.inList()) {
                        ...
                        int option = GetData.getInt("Would you like to (1) "
                                + "Make a Sale, (2) Place a new order");
                        switch (option) {
                            case 1:
                                int amtPurchased = GetData.getInt("Enter "
                                        + "amount for Purchase Order");
                                Product x = db.geProduct();
                                
                                if((x.getQuantity() - amtPurchased) < 0){
                                    JOptionPane.showMessageDialog(null, "Not "
                                    + "enough in stock: " + x.getQuantity());                                    
                                } 
                                else {
                                    x.makeSale(amtPurchased);
                                ...
                                break;
                            case 2:
                                int orderQuantity = GetData.getInt("Enter Order"
                                        + " Quantity");
                                Product y = db.geProduct();
                                
                                y.placeOrder(orderQuantity);
                ...
                case 4: // Delete Product
                    ...
                    name = GetData.getWord("Delete Product - Enter Name of "
                            + "Product");
                    ...
                    if (!db.inList()) {
                        ...
                        JOptionPane.showMessageDialog(null, "The product " 
                                + z.getName() + " has been deleted");
                    }

                    break;
                case 5: // View Product(s)
                    System.out.println("Case 4: View Products");

                    int view = GetData.getInt("What information would you like "
                            + "to view?\n 1. Single Product\n 2. All Active "
                            + "Products\n 3. All deleted products\n");

                    switch (view) {
                        case 1: // View A single product
                            name = GetData.getWord("Please enter name of "
                                    + "product");
